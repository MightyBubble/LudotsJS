...
import { Wand2, User, Crosshair, MapPin, Clock, Timer, Sparkles } from "lucide-react";
import { Input } from "@/components/ui/input";

export default function GameplayCueClipNode({ 
  clip,
  isSelected, 
  onSelect, 
  onDrag, 
  ...
  const dataFields = [
    { type: 'cueTag', label: 'Tag', value: clip.cueTag || '', icon: Wand2, isText: true },
      ...
      <div className="flex flex-row items-stretch h-full min-h-[110px]">
        ...
        <div className="flex-1 flex flex-row relative h-full p-1">
          ...
          <div className="flex flex-col justify-center gap-1 pl-6 pr-4 py-4 min-w-[120px] z-10">
            ...
            <span className="text-[9px] text-gray-500 font-mono select-none">Cue Clip</span>
          </div>
