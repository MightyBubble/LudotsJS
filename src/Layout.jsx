  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col">
      ...
      <div className="h-10 bg-[#141414] border-b border-[#262626] hidden md:flex items-center px-4 gap-1 overflow-x-auto">
        <Link to={createPageUrl("TagEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "TagEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Edit3 className="w-3.5 h-3.5" />标签
        </Link>
        <Link to={createPageUrl("TagSimulator")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "TagSimulator" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Zap className="w-3.5 h-3.5" />模拟器
        </Link>
        <div className="h-5 w-px bg-[#262626]" />
        <Link to={createPageUrl("ValidatorEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "ValidatorEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Shield className="w-3.5 h-3.5" />验证器
        </Link>
        <Link to={createPageUrl("RequirementEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "RequirementEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <CheckSquare className="w-3.5 h-3.5" />需求
        </Link>
        <Link to={createPageUrl("UnlockableCommands")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "UnlockableCommands" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <KeyRound className="w-3.5 h-3.5" />指令
        </Link>
        <Link to={createPageUrl("InteractionEffects")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "InteractionEffects" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Sparkles className="w-3.5 h-3.5" />效果
        </Link>
        <div className="h-5 w-px bg-[#262626]" />
        <Link to={createPageUrl("UnifiedGraphEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "UnifiedGraphEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Globe className="w-3.5 h-3.5" />图
        </Link>
        <Link to={createPageUrl("AttributeEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "AttributeEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Layers className="w-3.5 h-3.5" />属性
        </Link>
        <Link to={createPageUrl("ModifierDefinitionEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "ModifierDefinitionEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <GitBranch className="w-3.5 h-3.5" />修饰器
        </Link>
        <Link to={createPageUrl("EntityPrototypeEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "EntityPrototypeEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Box className="w-3.5 h-3.5" />原型
        </Link>
        <Link to={createPageUrl("EntityRelationEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "EntityRelationEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <LinkIcon className="w-3.5 h-3.5" />关系
        </Link>
        <Link to={createPageUrl("StructureEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "StructureEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Network className="w-3.5 h-3.5" />结构
        </Link>
        <Link to={createPageUrl("NewAttributeSimulator")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "NewAttributeSimulator" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Calculator className="w-3.5 h-3.5" />计算器
        </Link>
        <Link to={createPageUrl("GameEventEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "GameEventEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Zap className="w-3.5 h-3.5" />事件
        </Link>
        <Link to={createPageUrl("GlobalConstantEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "GlobalConstantEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
          <Settings className="w-3.5 h-3.5" />常量
        </Link>
        <Link to={createPageUrl("DataTableEditor")} className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs transition-colors whitespace-nowrap font-medium ${currentPageName === "DataTableEditor" ? "bg-[#f97316] text-black" : "text-gray-400 hover:bg-[#262626] hover:text-white"}`}>
