...
export default function PresenterParamsSection({ paramDefaults = [], onChangeParams }) {
  ...
  return <>
    <Section title="Param Defaults" right={
      ...
      <p className="text-xs text-gray-500">Presenter 参数黑板的初始值；lane 决定写入 Float / Int / Vector 通道。</p>
