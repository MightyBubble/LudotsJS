...
import PresenterMiniStateMachine from '@/components/presenter/PresenterMiniStateMachine';
...
export default function PresenterAnimatorPreviewTab({ root, presenters, controllers, profiles, stateIndex, onStateIndex }) {
  const animator = useMemo(() => findPreviewAnimator(root, presenters), [presenters, root]);
