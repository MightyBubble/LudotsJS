...
export default function VfxPreview({ asset }) {
  ...
  useEffect(() => {
    ...
    const runtime = createVfxRuntime(scene);
    const play = async () => {
  ...
  return <div className="space-y-2">
    <div className="flex items-center justify-between"><span className="rounded border border-[#424A55] bg-[#242A32] px-2 py-1 text-[11px] text-gray-300">three.quarks</span>
