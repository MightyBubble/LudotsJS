...
export default function AnimatorPreviewParameters({ parameters, values, onChange }) {
  ...
  return <div className="flex flex-col gap-2">
    {parameters.map(parameter => <label key={parameter.id} className="grid min-w-0 grid-cols-[minmax(0,1fr)_80px] items-center gap-3 rounded border border-[#2A2E37] bg-[#0D0F14] px-2 py-2 text-[11px] text-gray-400">
