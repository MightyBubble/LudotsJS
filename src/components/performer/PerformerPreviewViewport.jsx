...
export default function PerformerPreviewViewport({ root, selectedPerformerId, performers, bindings, assets, effects, targetSlot, mode, onModeChange, onTransform }) {
  const containerRef = useRef(null);
  const status = usePerformerPreviewScene(containerRef, root, performers, bindings, assets, effects, selectedPerformerId, targetSlot, mode, onTransform);
