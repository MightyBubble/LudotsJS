...
export default function PerformerPreviewViewport({ root, selectedInstancePath, performers, bindings, assets, effects, controllers, profiles, clips, activeStateIndex, targetSlot, mode, onModeChange, onSelectPath, onTransform }) {
  const containerRef = useRef(null);
  const status = usePerformerPreviewScene(containerRef, root, performers, bindings, assets, effects, controllers, profiles, clips, activeStateIndex, selectedInstancePath, targetSlot, mode, onSelectPath, onTransform);
