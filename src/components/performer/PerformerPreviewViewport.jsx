...
export default function PerformerPreviewViewport({ draft, performers, bindings, targetSlot, mode, onModeChange, onTransform }) {
  const containerRef = useRef(null);
  const status = usePerformerPreviewScene(containerRef, draft, performers, bindings, targetSlot, mode, onTransform);
  return (
    <div className="relative h-[360px] overflow-hidden rounded border border-[#424a55] bg-[#0D0F14]">
