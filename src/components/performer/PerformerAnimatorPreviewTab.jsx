...
export default function PerformerAnimatorPreviewTab({ root, performers, controllers, profiles, stateIndex, onStateIndex }) {
  ...
  return <div className="min-w-0 space-y-3">
    ...
    <div className="grid min-w-0 grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_190px]">
      <div className="h-[420px] min-w-0 overflow-hidden rounded border border-[#424a55]"><StateFlowCanvas key={controller.controller_id} layer={layer} defaultStateId={layer.default_state_id} selectedStateId={activeState?.id || ''} selectedTransitionId={runtime.activeTransitionId} onSelectState={selectState} onSelectTransition={() => {}} onUpdateLayer={() => {}} onOpenNested={() => {}} isPlaying activeStateId={activeState?.id} activeTransitionId={runtime.activeTransitionId} readOnly compact /></div>
