const TOP_LEVEL_FIELDS = ['ability_id','exec','onActivateEffects','cooldown','blockTags','catalogTags','interactionContextProfile','activationPrecondition','toggleSpec','targeting','presentation','input','useRequirement','showRequirement'];
