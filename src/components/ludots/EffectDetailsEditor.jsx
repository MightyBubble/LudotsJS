...
import EffectPresetEditor from './EffectPresetEditor';
import EffectCapabilitiesEditor from './EffectCapabilitiesEditor';
import RuntimeExportPanel from './RuntimeExportPanel';

export default function EffectDetailsEditor({ draft, patch, refs, issues, effects }) {
  return (
    <div className="max-w-3xl space-y-3">
      <EffectCoreEditor draft={draft} patch={patch} refs={refs} />
      <EffectPresetEditor draft={draft} patch={patch} refs={refs} />
      <EffectCapabilitiesEditor draft={draft} patch={patch} refs={refs} />
      <RuntimeExportPanel effects={effects} actionGraphs={refs.actionGraphs || []} />
