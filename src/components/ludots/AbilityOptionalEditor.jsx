...
export default function AbilityOptionalEditor({ draft, patch, domain = 'all' }) {
  ...
  return <>
    ...
    {showState && draft.toggleSpec?.deactivateExec && <AbilityExecEditor title="关闭执行 Deactivate Exec" value={draft.toggleSpec.deactivateExec} onChange={deactivateExec => patch({ toggleSpec: { ...draft.toggleSpec, deactivateExec } })} />}
