...
export const controlSchemeSpec = {
  entity:'ControlScheme', queryKey:'control-schemes', title:'Control Scheme', idKey:'scheme_id', idLabel:'Scheme ID',
...
export const commandIntentSpec = {
  entity:'CommandIntentProfile', queryKey:'command-intent-profiles', title:'Command Intent', idKey:'profile_id', idLabel:'Profile ID',
...
export const inputOrderSpec = {
  entity:'InputOrderConfig', queryKey:'input-order-configs', title:'Input Order Mapping', idKey:'config_id', idLabel:'Config ID',
...
export const castCommitSpec = {
  entity:'CastCommitProfile', queryKey:'cast-commit-profiles', title:'Cast Commit', idKey:'profile_id', idLabel:'Profile ID',
...
export const castDispatchSpec = {
  entity:'CastDispatchProfile', queryKey:'cast-dispatch-profiles', title:'Cast Dispatch', idKey:'profile_id', idLabel:'Profile ID',
