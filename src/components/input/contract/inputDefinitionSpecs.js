...
export const controlSchemeSpec = {
  entity:'ControlScheme', queryKey:'control-schemes', title:'Control Scheme', contract:'ControlSchemeDefinition', idKey:'scheme_id', idLabel:'Scheme ID',
...
export const commandIntentSpec = {
  entity:'CommandIntentProfile', queryKey:'command-intent-profiles', title:'Command Intent', contract:'CommandIntentProfileDefinition', idKey:'profile_id', idLabel:'Profile ID',
...
export const inputOrderSpec = {
  entity:'InputOrderConfig', queryKey:'input-order-configs', title:'Input Order Mapping', contract:'InputOrderMappingConfig', idKey:'config_id', idLabel:'Config ID',
...
export const castCommitSpec = {
  entity:'CastCommitProfile', queryKey:'cast-commit-profiles', title:'Cast Commit', contract:'CastCommitProfileDefinition', idKey:'profile_id', idLabel:'Profile ID',
...
export const castDispatchSpec = {
  entity:'CastDispatchProfile', queryKey:'cast-dispatch-profiles', title:'Cast Dispatch', contract:'CastDispatchProfileDefinition', idKey:'profile_id', idLabel:'Profile ID',
