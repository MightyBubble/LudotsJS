...
import { Search, Plus, Edit3, Trash2, X, Save, Sparkles, AlertTriangle } from "lucide-react";
...
export default function InteractionEffectsV2() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#1e1e1e] text-white">
      <div className="h-10 bg-[#2d2d2d] border-b border-[#3d3d3d] flex items-center px-4 gap-3">
        ...
        <span className="text-sm font-semibold text-gray-300">事件响应中心 V2</span>
        <span className="text-xs text-gray-500">管理游戏世界的即时反应 | 共 {filteredEffects.length} 个</span>
        ...
        <table className="w-full text-xs">
          <thead className="sticky top-0 bg-[#2d2d2d] border-b border-[#3d3d3d]">
            <tr>
              ...
              <th className="text-left p-2 font-semibold text-gray-300 w-40">触发效果标签</th>
              ...
              <th className="text-left p-2 font-semibold text-gray-300">后续效果/标签</th>
              ...
              <tr className="border-b border-[#3d3d3d] bg-[#252526]">
                ...
                <td className="p-2">
                  <div className="flex items-start gap-1 mb-1">
                    ...
                    <span className="text-xs text-yellow-400">可以是效果ID或直接的标签路径</span>
                  </div>
