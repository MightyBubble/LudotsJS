            ...
            {filteredRequirements.map((requirement) => {
              ...
              return (
                <tr key={requirement.id} className="border-b border-[#2A2E37] hover:bg-[#15171C]">
                  ...
                  <td className="p-2">
                    <div className="flex gap-1">
                      <Button size="sm" onClick={() => handleEdit(requirement)} className="h-6 w-6 p-0 bg-[#1E2128] hover:bg-[#2A2E37]">
                        <Edit3 className="w-3 h-3" />
                      </Button>
                      <Button size="sm" onClick={() => handleDelete(requirement.id)} className="h-6 w-6 p-0 bg-[#1E2128] hover:bg-[#7f1d1d]">
