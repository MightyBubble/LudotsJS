  ...
  return (
    <div className="h-screen flex flex-col bg-[#0D0F14] text-white">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* 左侧：输入源 */}
        <div className="w-72 bg-[#15171C] border-r border-[#2A2E37] flex flex-col overflow-hidden">
          <div className="flex-1 overflow-auto">
            {/* 被引用的标签 */}
            <div className="border-b border-[#2A2E37]">
              <div className="p-2 bg-[#15171C] border-b border-[#2A2E37]">
              ...
              <div className="p-2 space-y-1">
                {referencedInputs.tags.map(tagPath => {
                  ...
                  return (
                    <div key={tagPath} className="bg-[#0D0F14] border border-green-600/30 rounded p-2 flex items-center justify-between">
            ...
            <div className="border-b border-[#2A2E37]">
              ...
              <div className="p-2 space-y-1">
                {modifiers.map(mod => {
                  ...
                  return (
                    <div key={mod.id} className="bg-[#0D0F14] border border-purple-600/30 rounded p-2">
            ...
            <div className="border-b border-[#2A2E37]">
              ...
              <div className="p-2 space-y-1">
                {activeModifiers.map(output => {
                  ...
                  return (
                    <div key={mod.id} className="bg-[#0D0F14] border border-blue-600/30 rounded p-2">
                      <div className="text-[10px] text-gray-400 mb-1">{mod.modifier_name}</div>
              ...
              <div className="border-b border-[#2A2E37]">
                ...
                <div className="p-2 space-y-1">
                  {inactiveModifiers.map(output => {
                    ...
                    if (constantMappings.length === 0) return null;
                    return (
                      <div key={mod.id} className="bg-[#0D0F14] border border-gray-600/30 rounded p-2">
            ...
            <div>
              ...
              <div className="p-2 space-y-1">
                {unreferencedTags.map(tag => {
                  ...
                  return (
                    <div key={tag.id} className="bg-[#0D0F14] border border-[#2A2E37] rounded p-2 flex items-center justify-between opacity-50">
                      <div className="flex-1 min-w-0">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {sortedModifierOutputs.map((output, idx) => {
                ...
                return (
                  <div key={idx} className={`bg-[#15171C] border rounded p-3 relative ${borderColor} ${opacity}`}>
                    <button
                    ...
                    <div className="space-y-1 text-[10px] text-gray-400">
                      ...
                      <div className="flex items-center gap-2 mt-2 pt-2 border-t border-[#2A2E37]">
        ...
        {/* 右侧：属性聚合和最终值 */}
        <div className="w-96 bg-[#15171C] border-l border-[#2A2E37] flex flex-col overflow-auto">
          <div className="p-3 bg-[#15171C] border-b border-[#2A2E37] flex items-center gap-2">
