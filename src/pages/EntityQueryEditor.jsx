...
export default function EntityQueryEditorPage() {
  ...
  const getNodeInputs = (type) => {
    const inputConfigs = {
      ...
      'spatial_pathfinding': [{ id: 'entities', label: '实体集', type: 'entities' }],
      'spatial_area': [{ id: 'entities', label: '实体集', type: 'entities' }],
      'spatial_nearest': [{ id: 'entities', label: '实体集', type: 'entities' }],
  ...
  const getNodeOutputs = (type) => {
    const outputConfigs = {
      ...
      'spatial_pathfinding': [{ id: 'filtered', label: '过滤结果', type: 'entities' }],
      'spatial_area': [{ id: 'filtered', label: '过滤结果', type: 'entities' }],
      'spatial_nearest': [{ id: 'filtered', label: '过滤结果', type: 'entities' }],
